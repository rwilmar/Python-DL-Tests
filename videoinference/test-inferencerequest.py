...
#it's necessary to have OpenVino toolkint up & running
#get the openvino cpu ext library
#CPU_EXTENSION = "/opt/intel/openvino/deployment_tools/inference_engine/lib/intel64/libcpu_extension_sse4.so"
CPU_EXTENSION = "/opt/intel/openvino/deployment_tools/inference_engine/lib/intel64/libcpu_extension.dylib"

#It must contain the Intermediate Representation of DL network, 
# -use Model Optimizer BEFORE testing!
MODEL_PATH = "/Users/rwilmar/openvino_models/intel/"
...
def pose_test():
    counter = 0
    model = MODEL_PATH + "human-pose-estimation-0001/INT8/human-pose-estimation-0001.xml"
